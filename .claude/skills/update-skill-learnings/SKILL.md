...
- After reviewing skill quality (like the ulpi-generate-guards review)
...
| **Skill-Specific** | Learnings about one particular skill | ulpi-generate-guards needs same patterns as commit |
...
**Session Issue:** ulpi-generate-guards was missing patterns that commit/create-pr/start have.

**Learning Extraction:**
- Category: Skill-Specific
- Skill: ulpi-generate-guards
- Learning: "Apply same structural patterns as commit/create-pr/start for consistency"

**Result:**
1. Added to `.claude/learnings/skill-learnings.md` under Skill-Specific Learnings → ulpi-generate-guards
