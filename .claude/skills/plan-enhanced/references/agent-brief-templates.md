...
- **Files:** [Relevant file paths — identified via `mcp__codemap__search_code`]
- **Context:** [Existing patterns, constraints, related code]
- **Output:** [Expected deliverables]
- **Success criteria:** [How to verify completion]

**Search:** Use `mcp__codemap__search_code` for semantic search and `mcp__codemap__search_symbols` for finding functions/types. Fall back to Glob/Grep for exact patterns.
```
...
```markdown
**Brief:**
- **Scope:** [Deep multi-round investigation that CodeMap couldn't answer]
- **Why Explore:** [Explain why CodeMap + Glob/Grep were insufficient]
- **Already tried:**
  - `mcp__codemap__search_code("[query]")` → [what it found / why insufficient]
  - Glob/Grep: `[pattern]` → [what it found / why insufficient]
- **Still need:**
  - [What specifically requires multi-round investigation]
...
☐ Brief includes **Search** instruction for CodeMap MCP tools
☐ Files were identified via CodeMap, not guessed
```
